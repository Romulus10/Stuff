...
;;;;;;;;;; CLRA                                                     ;
           LDA       0,i                                            ;< CLRA >
           STA       LL7,d                                          ;count is set to 0 at first
;;;;;;;;;; CLRX                                                     ;
           LDX       0,i                                            ;< CLRX >
;------------------------------------------
LL8:       CPA       n,s                                            ;compare the LL7 (loaded into A) with n(amount of str we have)
           BRGE      LL9                                            ;if it's Greater than or Equal to, we are LL9
           LDA       LL6,sxf                                        ;load the next addr of the p[] into A
           ...
           LDA       LL7,d                                          ;load LL7 into A, increment it, and LL8 back until all str are printed
;;;;;;;;;; INCA                                                     ;
           ADDA      1,i                                            ;< INCA >
           STA       LL7,d
           BR        LL8
