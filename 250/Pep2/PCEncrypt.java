...
public class PCEncrypt  {
    static char stringArray[] = {'1', '4', '3', '8', '6', '0', '8', '4', '3'};
    static String realString = new String(stringArray);
    static char delimeter[] = {'x'};
    ...
    public static String _debug_symbol_d(String _debug_symbol_string)  {
        ...
        StringTokenizer _debug_symbol_tok = new StringTokenizer(_debug_symbol_string, new String(delimeter));
        ...
        for (int _debug_symbol_i = 0; _debug_symbol_i < _debug_symbol_nCh; ++_debug_symbol_i)  {
            int _debug_symbol_keyIdx = _debug_symbol_i % realString.length();
            int _debug_symbol_keyVal = realString.charAt(_debug_symbol_keyIdx);
